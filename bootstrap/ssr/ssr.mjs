...
const Ziggy$1 = { "url": "https://waykapay.com", "port": null, "defaults": {}, "routes": { "debugbar.openhandler": { "uri": "_debugbar/open", "methods": ["GET", "HEAD"] }, "debugbar.clockwork": { "uri": "_debugbar/clockwork/{id}", "methods": ["GET", "HEAD"], "parameters": ["id"] }, "debugbar.assets.css": { "uri": "_debugbar/assets/stylesheets", "methods": ["GET", "HEAD"] }, "debugbar.assets.js": { "uri": "_debugbar/assets/javascript", "methods": ["GET", "HEAD"] }, "debugbar.cache.delete": { "uri": "_debugbar/cache/{key}/{tags?}", "methods": ["DELETE"], "parameters": ["key", "tags"] }, "login": { "uri": "login", "methods": ["GET", "HEAD"] }, "logout": { "uri": "logout", "methods": ["POST"] }, "password.request": { "uri": "forgot-password", "methods": ["GET", "HEAD"] }, "password.reset": { "uri": "reset-password/{token}", "methods": ["GET", "HEAD"], "parameters": ["token"] }, "password.email": { "uri": "forgot-password", "methods": ["POST"] }, "password.update": { "uri": "reset-password", "methods": ["POST"] }, "register": { "uri": "register", "methods": ["GET", "HEAD"] }, "verification.notice": { "uri": "email/verify", "methods": ["GET", "HEAD"] }, "verification.verify": { "uri": "email/verify/{id}/{hash}", "methods": ["GET", "HEAD"], "parameters": ["id", "hash"] }, "verification.send": { "uri": "email/verification-notification", "methods": ["POST"] }, "user-profile-information.update": { "uri": "user/profile-information", "methods": ["PUT"] }, "user-password.update": { "uri": "user/password", "methods": ["PUT"] }, "password.confirmation": { "uri": "user/confirmed-password-status", "methods": ["GET", "HEAD"] }, "password.confirm": { "uri": "user/confirm-password", "methods": ["POST"] }, "terms.show": { "uri": "terms-of-service", "methods": ["GET", "HEAD"] }, "policy.show": { "uri": "privacy-policy", "methods": ["GET", "HEAD"] }, "profile.show": { "uri": "user/profile", "methods": ["GET", "HEAD"] }, "other-browser-sessions.destroy": { "uri": "user/other-browser-sessions", "methods": ["DELETE"] }, "current-user-photo.destroy": { "uri": "user/profile-photo", "methods": ["DELETE"] }, "current-user.destroy": { "uri": "user", "methods": ["DELETE"] }, "sanctum.csrf-cookie": { "uri": "sanctum/csrf-cookie", "methods": ["GET", "HEAD"] }, "ignition.healthCheck": { "uri": "_ignition/health-check", "methods": ["GET", "HEAD"] }, "ignition.executeSolution": { "uri": "_ignition/execute-solution", "methods": ["POST"] }, "ignition.updateConfig": { "uri": "_ignition/update-config", "methods": ["POST"] }, "landing.welcome": { "uri": "/", "methods": ["GET", "HEAD"] }, "landing.upgrade": { "uri": "premium", "methods": ["GET", "HEAD"] }, "transaction.print": { "uri": "print/{transaction}", "methods": ["GET", "HEAD"], "parameters": ["transaction"] }, "transaction.share": { "uri": "share/{transaction}", "methods": ["GET", "HEAD"], "parameters": ["transaction"] }, "login.otp": { "uri": "login-otp", "methods": ["GET", "HEAD"] }, "dashboard": { "uri": "dashboard", "methods": ["GET", "HEAD"] }, "otp.create": { "uri": "otp/create", "methods": ["GET", "HEAD"] }, "otp.req": { "uri": "otp/request", "methods": ["GET", "HEAD"] }, "otp.acc": { "uri": "otp/acc", "methods": ["POST"] }, "deposit.index": { "uri": "deposit", "methods": ["GET", "HEAD"] }, "deposit.method": { "uri": "deposit/method", "methods": ["POST"] }, "deposit.create": { "uri": "deposit/create", "methods": ["POST"] }, "deposit.confirm": { "uri": "deposit/confirm", "methods": ["PUT"] }, "money-transfer.index": { "uri": "money-transfer", "methods": ["GET", "HEAD"] }, "money-transfer.amount": { "uri": "money-transfer/amount", "methods": ["POST"] }, "money-transfer.confirm": { "uri": "money-transfer/confirm", "methods": ["POST"] }, "money-transfer.test": { "uri": "money-transfer/test", "methods": ["GET", "HEAD"] }, "payment.success": { "uri": "payment/success", "methods": ["GET", "HEAD"] }, "history.index": { "uri": "history", "methods": ["GET", "HEAD"] }, "history.create": { "uri": "history/create", "methods": ["GET", "HEAD"] }, "history.store": { "uri": "history", "methods": ["POST"] }, "history.show": { "uri": "history/{history}", "methods": ["GET", "HEAD"], "parameters": ["history"] }, "history.edit": { "uri": "history/{history}/edit", "methods": ["GET", "HEAD"], "parameters": ["history"] }, "history.update": { "uri": "history/{history}", "methods": ["PUT", "PATCH"], "parameters": ["history"] }, "history.destroy": { "uri": "history/{history}", "methods": ["DELETE"], "parameters": ["history"] }, "product.topup": { "uri": "product/topup", "methods": ["POST"] }, "product.topup.pasca": { "uri": "product/topup-pasca", "methods": ["POST"] }, "product.status": { "uri": "product/status", "methods": ["GET", "HEAD"] }, "pulsa.index": { "uri": "product/pulsa", "methods": ["GET", "HEAD"] }, "pln.index": { "uri": "product/pln", "methods": ["GET", "HEAD"] }, "pln.prepaid.index": { "uri": "product/pln-prepaid", "methods": ["GET", "HEAD"] }, "pln.prepaid.inquiry": { "uri": "product/pln-prepaid-inquiry", "methods": ["GET", "HEAD"] }, "games.index": { "uri": "product/games", "methods": ["GET", "HEAD"] }, "games.show": { "uri": "product/games/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"] }, "emoney.index": { "uri": "product/emoney", "methods": ["GET", "HEAD"] }, "emoney.show": { "uri": "product/emoney/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"] }, "etoll.index": { "uri": "product/etoll", "methods": ["GET", "HEAD"] }, "etoll.show": { "uri": "product/etoll/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"] }, "voucher.index": { "uri": "product/voucher", "methods": ["GET", "HEAD"] }, "voucher.show": { "uri": "product/voucher/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"] }, "television.index": { "uri": "product/television", "methods": ["GET", "HEAD"] }, "television.show": { "uri": "product/television/{product}", "methods": ["GET", "HEAD"], "parameters": ["product"] }, "pasca.index": { "uri": "product/pasca/{sku}", "methods": ["GET", "HEAD"], "parameters": ["sku"] }, "pasca.inquiry": { "uri": "product/pasca/inquiry", "methods": ["POST"] }, "pasca.internet.index": { "uri": "product/internet", "methods": ["GET", "HEAD"] }, "pasca.bpjs.index": { "uri": "product/bpjs", "methods": ["GET", "HEAD"] }, "pasca.multifinance.index": { "uri": "product/multifinance", "methods": ["GET", "HEAD"] }, "information.index": { "uri": "information", "methods": ["GET", "HEAD"] }, "information.create": { "uri": "information/create", "methods": ["GET", "HEAD"] }, "information.store": { "uri": "information", "methods": ["POST"] }, "information.show": { "uri": "information/{information}", "methods": ["GET", "HEAD"], "parameters": ["information"], "bindings": { "information": "id" } }, "information.edit": { "uri": "information/{information}/edit", "methods": ["GET", "HEAD"], "parameters": ["information"], "bindings": { "information": "id" } }, "information.update": { "uri": "information/{information}", "methods": ["PUT", "PATCH"], "parameters": ["information"], "bindings": { "information": "id" } }, "information.destroy": { "uri": "information/{information}", "methods": ["DELETE"], "parameters": ["information"], "bindings": { "information": "id" } }, "carousel.index": { "uri": "carousel", "methods": ["GET", "HEAD"] }, "carousel.create": { "uri": "carousel/create", "methods": ["GET", "HEAD"] }, "carousel.store": { "uri": "carousel", "methods": ["POST"] }, "carousel.show": { "uri": "carousel/{carousel}", "methods": ["GET", "HEAD"], "parameters": ["carousel"], "bindings": { "carousel": "id" } }, "carousel.edit": { "uri": "carousel/{carousel}/edit", "methods": ["GET", "HEAD"], "parameters": ["carousel"], "bindings": { "carousel": "id" } }, "carousel.update": { "uri": "carousel/{carousel}", "methods": ["PUT", "PATCH"], "parameters": ["carousel"], "bindings": { "carousel": "id" } }, "carousel.destroy": { "uri": "carousel/{carousel}", "methods": ["DELETE"], "parameters": ["carousel"], "bindings": { "carousel": "id" } }, "transaction.detail": { "uri": "transaction/detail", "methods": ["GET", "HEAD"] }, "transaction.index": { "uri": "transaction", "methods": ["GET", "HEAD"] }, "transaction.create": { "uri": "transaction/create", "methods": ["GET", "HEAD"] }, "transaction.store": { "uri": "transaction", "methods": ["POST"] }, "transaction.show": { "uri": "transaction/{transaction}", "methods": ["GET", "HEAD"], "parameters": ["transaction"] }, "transaction.edit": { "uri": "transaction/{transaction}/edit", "methods": ["GET", "HEAD"], "parameters": ["transaction"] }, "transaction.update": { "uri": "transaction/{transaction}", "methods": ["PUT", "PATCH"], "parameters": ["transaction"], "bindings": { "transaction": "id" } }, "transaction.destroy": { "uri": "transaction/{transaction}", "methods": ["DELETE"], "parameters": ["transaction"] }, "report.detail": { "uri": "report/detail", "methods": ["GET", "HEAD"] }, "report.index": { "uri": "report", "methods": ["GET", "HEAD"] }, "report.create": { "uri": "report/create", "methods": ["GET", "HEAD"] }, "report.store": { "uri": "report", "methods": ["POST"] }, "report.show": { "uri": "report/{report}", "methods": ["GET", "HEAD"], "parameters": ["report"] }, "report.edit": { "uri": "report/{report}/edit", "methods": ["GET", "HEAD"], "parameters": ["report"] }, "report.update": { "uri": "report/{report}", "methods": ["PUT", "PATCH"], "parameters": ["report"] }, "report.destroy": { "uri": "report/{report}", "methods": ["DELETE"], "parameters": ["report"] }, "upgrade.index": { "uri": "upgrade", "methods": ["GET", "HEAD"] }, "upgrade.create": { "uri": "upgrade/create", "methods": ["GET", "HEAD"] }, "upgrade.store": { "uri": "upgrade", "methods": ["POST"] }, "upgrade.show": { "uri": "upgrade/{upgrade}", "methods": ["GET", "HEAD"], "parameters": ["upgrade"], "bindings": { "upgrade": "id" } }, "upgrade.edit": { "uri": "upgrade/{upgrade}/edit", "methods": ["GET", "HEAD"], "parameters": ["upgrade"], "bindings": { "upgrade": "id" } }, "upgrade.update": { "uri": "upgrade/{upgrade}", "methods": ["PUT", "PATCH"], "parameters": ["upgrade"], "bindings": { "upgrade": "id" } }, "upgrade.destroy": { "uri": "upgrade/{upgrade}", "methods": ["DELETE"], "parameters": ["upgrade"], "bindings": { "upgrade": "id" } }, "pin.index": { "uri": "pin", "methods": ["GET", "HEAD"] }, "pin.create": { "uri": "pin/create", "methods": ["GET", "HEAD"] }, "pin.store": { "uri": "pin", "methods": ["POST"] }, "pin.show": { "uri": "pin/{pin}", "methods": ["GET", "HEAD"], "parameters": ["pin"] }, "pin.edit": { "uri": "pin/{pin}/edit", "methods": ["GET", "HEAD"], "parameters": ["pin"] }, "pin.update": { "uri": "pin/{pin}", "methods": ["PUT", "PATCH"], "parameters": ["pin"] }, "pin.destroy": { "uri": "pin/{pin}", "methods": ["DELETE"], "parameters": ["pin"] }, "pin.moneyTransfer": { "uri": "pin-money-transfer", "methods": ["POST"] }, "pin.topup": { "uri": "pin-topup", "methods": ["POST"] }, "pin.topupPasca": { "uri": "pin-topup-pasca", "methods": ["POST"] }, "pin.manualTransfer": { "uri": "pin-manual-transfer", "methods": ["POST"] }, "pin.wrong": { "uri": "pin-wrong", "methods": ["GET", "HEAD"] }, "user.index": { "uri": "user", "methods": ["GET", "HEAD"] }, "user.create": { "uri": "user/create", "methods": ["GET", "HEAD"] }, "user.store": { "uri": "user", "methods": ["POST"] }, "user.show": { "uri": "user/{user}", "methods": ["GET", "HEAD"], "parameters": ["user"], "bindings": { "user": "slug" } }, "user.edit": { "uri": "user/{user}/edit", "methods": ["GET", "HEAD"], "parameters": ["user"] }, "user.update": { "uri": "user/{user}", "methods": ["PUT", "PATCH"], "parameters": ["user"], "bindings": { "user": "slug" } }, "user.destroy": { "uri": "user/{user}", "methods": ["DELETE"], "parameters": ["user"] }, "user.passwordReset": { "uri": "users/reset-password/{user}", "methods": ["POST"], "parameters": ["user"], "bindings": { "user": "slug" } }, "user.normalizeTransaction": { "uri": "user/normalize-transaction/{user}", "methods": ["GET", "HEAD"], "parameters": ["user"], "bindings": { "user": "slug" } }, "device.index": { "uri": "device", "methods": ["GET", "HEAD"] }, "device.store": { "uri": "device/store", "methods": ["GET", "HEAD"] }, "device.subscribe": { "uri": "device/subscribe", "methods": ["GET", "HEAD"] }, "device.send": { "uri": "device/send", "methods": ["POST"] }, "pricing.index": { "uri": "pricing", "methods": ["GET", "HEAD"] }, "profile.index": { "uri": "profile", "methods": ["GET", "HEAD"] }, "setting.index": { "uri": "setting", "methods": ["GET", "HEAD"] }, "setting.create": { "uri": "setting/create", "methods": ["GET", "HEAD"] }, "setting.store": { "uri": "setting", "methods": ["POST"] }, "setting.show": { "uri": "setting/{setting}", "methods": ["GET", "HEAD"], "parameters": ["setting"] }, "setting.edit": { "uri": "setting/{setting}/edit", "methods": ["GET", "HEAD"], "parameters": ["setting"] }, "setting.update": { "uri": "setting/{setting}", "methods": ["PUT", "PATCH"], "parameters": ["setting"] }, "setting.destroy": { "uri": "setting/{setting}", "methods": ["DELETE"], "parameters": ["setting"] } } };
...
createServer(
  (page) => createInertiaApp({
    ...
    // },
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/API/Index.vue": () => import("./assets/Index-45304af3.mjs"), "./Pages/API/Partials/ApiTokenManager.vue": () => import("./assets/ApiTokenManager-e11fbfff.mjs"), "./Pages/AppSetting/Partials/UpdateApiDigiflazzForm.vue": () => import("./assets/UpdateApiDigiflazzForm-d22ffbb6.mjs"), "./Pages/AppSetting/Partials/UpdateApiFlipForm.vue": () => import("./assets/UpdateApiFlipForm-a3a688fc.mjs"), "./Pages/AppSetting/Partials/UpdateApiMidtransForm.vue": () => import("./assets/UpdateApiMidtransForm-3c40bcf4.mjs"), "./Pages/AppSetting/Partials/UpdateAppInformationForm.vue": () => import("./assets/UpdateAppInformationForm-53b8d8c6.mjs"), "./Pages/AppSetting/Partials/UpdateFeeEmoneyForm.vue": () => import("./assets/UpdateFeeEmoneyForm-44e91204.mjs"), "./Pages/AppSetting/Partials/UpdateFeeEtollForm.vue": () => import("./assets/UpdateFeeEtollForm-ab81032c.mjs"), "./Pages/AppSetting/Partials/UpdateFeeGamesForm.vue": () => import("./assets/UpdateFeeGamesForm-a13468d4.mjs"), "./Pages/AppSetting/Partials/UpdateFeeInternetForm.vue": () => import("./assets/UpdateFeeInternetForm-8ed31fa6.mjs"), "./Pages/AppSetting/Partials/UpdateFeePlnForm.vue": () => import("./assets/UpdateFeePlnForm-71c301ff.mjs"), "./Pages/AppSetting/Partials/UpdateFeePulsaForm.vue": () => import("./assets/UpdateFeePulsaForm-90373c08.mjs"), "./Pages/AppSetting/Partials/UpdateFeeTVForm.vue": () => import("./assets/UpdateFeeTVForm-0fe10e2b.mjs"), "./Pages/AppSetting/Partials/UpdateFeeVoucherForm.vue": () => import("./assets/UpdateFeeVoucherForm-f4fbee71.mjs"), "./Pages/AppSetting/Show.vue": () => import("./assets/Show-dd4d2121.mjs"), "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-b5135ffe.mjs"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-36309396.mjs"), "./Pages/Auth/Login.vue": () => import("./assets/Login-9f5c223d.mjs"), "./Pages/Auth/Register.vue": () => import("./assets/Register-76ca4e5b.mjs"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-20a38816.mjs"), "./Pages/Auth/TwoFactorChallenge.vue": () => import("./assets/TwoFactorChallenge-fc0c559a.mjs"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-18ce5dff.mjs"), "./Pages/Carousel/Index.vue": () => import("./assets/Index-496aa4b6.mjs"), "./Pages/Carousel/Partials/DeleteForm.vue": () => import("./assets/DeleteForm-85cacc2e.mjs"), "./Pages/Carousel/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-0d99d8cd.mjs"), "./Pages/Carousel/Show.vue": () => import("./assets/Show-450c6653.mjs"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-85ca6228.mjs"), "./Pages/Deposit/Bank.vue": () => import("./assets/Bank-8b5eed77.mjs"), "./Pages/Deposit/Confirm.vue": () => import("./assets/Confirm-d318809e.mjs"), "./Pages/Deposit/CreateEdit.vue": () => import("./assets/CreateEdit-0d984a6c.mjs"), "./Pages/Deposit/Partials/UpdateBankForm.vue": () => import("./assets/UpdateBankForm-0b54d725.mjs"), "./Pages/Deposit/Partials/UpdateInformationForm.vue": () => import("./assets/UpdateInformationForm-c880b107.mjs"), "./Pages/Device/Index.vue": () => import("./assets/Index-90602f7a.mjs"), "./Pages/Device/Partials/NotificationForm.vue": () => import("./assets/NotificationForm-d7cd6eb0.mjs"), "./Pages/History/Index.vue": () => import("./assets/Index-003f1516.mjs"), "./Pages/History/Print.vue": () => import("./assets/Print-c89f3a5c.mjs"), "./Pages/History/Share.vue": () => import("./assets/Share-77c49227.mjs"), "./Pages/History/Show.vue": () => import("./assets/Show-905f16f5.mjs"), "./Pages/Information/Index.vue": () => import("./assets/Index-5b13fb89.mjs"), "./Pages/Landing/Welcome.vue": () => import("./assets/Welcome-c4fc332f.mjs"), "./Pages/MoneyTransfer/Bank.vue": () => import("./assets/Bank-17c02afe.mjs"), "./Pages/MoneyTransfer/CreateEdit.vue": () => import("./assets/CreateEdit-68bc4334.mjs"), "./Pages/MoneyTransfer/Partials/UpdateBankForm.vue": () => import("./assets/UpdateBankForm-8a2947f9.mjs"), "./Pages/MoneyTransfer/Partials/UpdateInformationForm.vue": () => import("./assets/UpdateInformationForm-ed7a4738.mjs"), "./Pages/Payment/Error.vue": () => import("./assets/Error-867394a8.mjs"), "./Pages/Payment/Info.vue": () => import("./assets/Info-db746952.mjs"), "./Pages/Payment/Pending.vue": () => import("./assets/Pending-b8a5209a.mjs"), "./Pages/Payment/Success.vue": () => import("./assets/Success-f89a6c61.mjs"), "./Pages/Pin/CreateEdit.vue": () => import("./assets/CreateEdit-bef13245.mjs"), "./Pages/Pin/Index.vue": () => import("./assets/Index-05f0596a.mjs"), "./Pages/Pin/ManualTransfer.vue": () => import("./assets/ManualTransfer-c9ed1798.mjs"), "./Pages/Pin/MoneyTransfer.vue": () => import("./assets/MoneyTransfer-9f28206a.mjs"), "./Pages/Pin/Otp.vue": () => import("./assets/Otp-6ff71c68.mjs"), "./Pages/Pin/Topup.vue": () => import("./assets/Topup-7d4ae0ad.mjs"), "./Pages/Pin/TopupPasca.vue": () => import("./assets/TopupPasca-f083ca1a.mjs"), "./Pages/Pin/Wrong.vue": () => import("./assets/Wrong-2ffc342e.mjs"), "./Pages/Pricing/Index.vue": () => import("./assets/Index-ecb6b52c.mjs"), "./Pages/Pricing/Partials/FormatEmoney.vue": () => import("./assets/FormatEmoney-882053b0.mjs"), "./Pages/Pricing/Partials/FormatGames.vue": () => import("./assets/FormatGames-802f3ff2.mjs"), "./Pages/Pricing/Partials/FormatPln.vue": () => import("./assets/FormatPln-14a4a72d.mjs"), "./Pages/Pricing/Partials/FormatPulsa.vue": () => import("./assets/FormatPulsa-5bc45ed9.mjs"), "./Pages/Pricing/Partials/FormatTV.vue": () => import("./assets/FormatTV-f6aca9e4.mjs"), "./Pages/Pricing/Partials/FormatVoucher.vue": () => import("./assets/FormatVoucher-7283b783.mjs"), "./Pages/Pricing/Partials/PriceList.vue": () => import("./assets/PriceList-26abdbe4.mjs"), "./Pages/PrivacyPolicy.vue": () => import("./assets/PrivacyPolicy-077df471.mjs"), "./Pages/Product/Emoney/Index.vue": () => import("./assets/Index-d836f088.mjs"), "./Pages/Product/Emoney/Show.vue": () => import("./assets/Show-f7da23d3.mjs"), "./Pages/Product/Etoll/Index.vue": () => import("./assets/Index-5f04cbb2.mjs"), "./Pages/Product/Etoll/Show.vue": () => import("./assets/Show-026fc10a.mjs"), "./Pages/Product/Games/Index.vue": () => import("./assets/Index-8434a756.mjs"), "./Pages/Product/Games/Show.vue": () => import("./assets/Show-3cd5bfe9.mjs"), "./Pages/Product/Loading.vue": () => import("./assets/Loading-860dd56d.mjs"), "./Pages/Product/Pasca/CreateEdit.vue": () => import("./assets/CreateEdit-490b52d7.mjs"), "./Pages/Product/Pasca/Index.vue": () => import("./assets/Index-4b48e847.mjs"), "./Pages/Product/PascaBpjs/Index.vue": () => import("./assets/Index-afb70e08.mjs"), "./Pages/Product/PascaInternet/Index.vue": () => import("./assets/Index-56ce7960.mjs"), "./Pages/Product/PascaMultifinance/Index.vue": () => import("./assets/Index-89d3919e.mjs"), "./Pages/Product/Pln/Index.vue": () => import("./assets/Index-77d9b439.mjs"), "./Pages/Product/Pln/Prepaid/CreateEdit.vue": () => import("./assets/CreateEdit-cf386321.mjs"), "./Pages/Product/Pln/Prepaid/Index.vue": () => import("./assets/Index-ebaa87a3.mjs"), "./Pages/Product/Pulsa/Index.vue": () => import("./assets/Index-202513ec.mjs"), "./Pages/Product/Show.vue": () => import("./assets/Show-537e75f2.mjs"), "./Pages/Product/Television/Index.vue": () => import("./assets/Index-b733fb55.mjs"), "./Pages/Product/Television/Show.vue": () => import("./assets/Show-59ca80e2.mjs"), "./Pages/Product/Voucher/Index.vue": () => import("./assets/Index-a52f9a4c.mjs"), "./Pages/Product/Voucher/Show.vue": () => import("./assets/Show-1e6bdc61.mjs"), "./Pages/Profile/Index.vue": () => import("./assets/Index-f1dce57f.mjs"), "./Pages/Profile/Partials/DeleteUserForm.vue": () => import("./assets/DeleteUserForm-126e9b72.mjs"), "./Pages/Profile/Partials/LogoutOtherBrowserSessionsForm.vue": () => import("./assets/LogoutOtherBrowserSessionsForm-dd0d5815.mjs"), "./Pages/Profile/Partials/TwoFactorAuthenticationForm.vue": () => import("./assets/TwoFactorAuthenticationForm-5c4991f8.mjs"), "./Pages/Profile/Partials/UpdatePasswordForm.vue": () => import("./assets/UpdatePasswordForm-c714e013.mjs"), "./Pages/Profile/Partials/UpdatePinForm.vue": () => import("./assets/UpdatePinForm-f3c35e2f.mjs"), "./Pages/Profile/Partials/UpdateProfileInformationForm.vue": () => import("./assets/UpdateProfileInformationForm-7c86c8e5.mjs"), "./Pages/Profile/Show.vue": () => import("./assets/Show-dbf19376.mjs"), "./Pages/Report/Detail.vue": () => import("./assets/Detail-a5016d3b.mjs"), "./Pages/Report/Index.vue": () => import("./assets/Index-b3ad26ad.mjs"), "./Pages/TermsOfService.vue": () => import("./assets/TermsOfService-7826e14a.mjs"), "./Pages/Transaction/Detail.vue": () => import("./assets/Detail-5f598fac.mjs"), "./Pages/Transaction/Index.vue": () => import("./assets/Index-a22d5aae.mjs"), "./Pages/Upgrade/CreateEdit.vue": () => import("./assets/CreateEdit-055261cc.mjs"), "./Pages/Upgrade/Index.vue": () => import("./assets/Index-e104d3f6.mjs"), "./Pages/User/CreateEdit.vue": () => import("./assets/CreateEdit-e9ccc22f.mjs"), "./Pages/User/Index.vue": () => import("./assets/Index-84f4016e.mjs"), "./Pages/User/Partials/DeleteForm.vue": () => import("./assets/DeleteForm-ca5ee7bd.mjs"), "./Pages/User/Partials/PasswordResetForm.vue": () => import("./assets/PasswordResetForm-c5ba20f3.mjs"), "./Pages/User/Partials/UpdateInformationForm.vue": () => import("./assets/UpdateInformationForm-850aa740.mjs"), "./Pages/User/Show.vue": () => import("./assets/Show-ccab25e2.mjs"), "./Pages/Welcome.vue": () => import("./assets/Welcome-feefa3e7.mjs") })),
    setup({ App, props, plugin }) {
      console.log("ssr is alive");
      return createSSRApp({
        render: () => h$1(App, props)
      }).use(plugin).use(P, Ziggy$1, VueClipboard, VueQrcode, MotionPlugin);
    }
  })
);
