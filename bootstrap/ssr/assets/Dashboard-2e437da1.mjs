        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-credit-card text-2xl text-blue-600 dark:text-gray-900"${_scopeId2}></i><p class="text-xs text-blue-600 dark:text-gray-900"${_scopeId2}>Cicilan</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
