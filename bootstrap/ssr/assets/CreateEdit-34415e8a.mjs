import { mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, unref, openBlock, createBlock, Fragment, useSSRContext } from "vue";
            ...
            _push2(ssrRenderComponent(_sfc_main$3, { class: "sticky top-0 z-40" }, {
              ...
              form: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<div class="font-semibold text-gray-900"${_scopeId2}>${ssrInterpolate(props.customer.data.desc.tarif)} ${ssrInterpolate(props.customer.data.desc.daya ?? " ")}</div></div><div class="col-span-6 sm:col-span-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    for: "number",
