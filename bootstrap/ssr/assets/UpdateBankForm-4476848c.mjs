import { withCtx, unref, isRef, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, useSSRContext } from "vue";
            ...
            _push2(ssrRenderComponent(unref(RadioGroup), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$2, { value: "Virtual Account" }, null, _parent3, _scopeId2));
                  ...
                  _push3(`<!--]--></div></div><div class="mt-5"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$2, { value: "Manual Transfer" }, null, _parent3, _scopeId2));
                  _push3(`<div class="mt-4 grid grid-cols-2 gap-y-6 sm:grid-cols-3 gap-x-4"${_scopeId2}><!--[-->`);
                  ...
                  _push3(`<!--]--></div></div><div class="mt-5"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$2, { value: "Retail" }, null, _parent3, _scopeId2));
                  _push3(`<div class="mt-4 grid grid-cols-2 gap-y-6 sm:grid-cols-3 gap-x-4"${_scopeId2}><!--[-->`);
                  ssrRenderList(offline, (mailingList) => {
                    _push3(ssrRenderComponent(unref(RadioGroupOption), {
                      as: "template",
                      key: mailingList.id,
                      value: mailingList
                  ...
                  return [
                    createVNode("div", { class: "" }, [
                      createVNode(_sfc_main$2, { value: "Virtual Account" }),
                    ...
                    createVNode("div", { class: "mt-5" }, [
                      createVNode(_sfc_main$2, { value: "Manual Transfer" }),
                      createVNode("div", { class: "mt-4 grid grid-cols-2 gap-y-6 sm:grid-cols-3 gap-x-4" }, [
                    ...
                    createVNode("div", { class: "mt-5" }, [
                      createVNode(_sfc_main$2, { value: "Retail" }),
                      createVNode("div", { class: "mt-4 grid grid-cols-2 gap-y-6 sm:grid-cols-3 gap-x-4" }, [
                        (openBlock(), createBlock(Fragment, null, renderList(offline, (mailingList) => {
                          return createVNode(unref(RadioGroupOption), {
                            as: "template",
                            key: mailingList.id,
                            value: mailingList
