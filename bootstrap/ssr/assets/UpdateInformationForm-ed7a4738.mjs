import { computed, ref, watch, withCtx, createVNode, toDisplayString, createTextVNode, unref, openBlock, createBlock, createCommentVNode, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate } from "vue/server-renderer";
import { useForm, usePage } from "@inertiajs/vue3";
import { _ as _sfc_main$7 } from "./ActionMessage-c43f20d9.mjs";
import { _ as _sfc_main$2 } from "./FormSection-d7f7af6c.mjs";
...
import { a as _sfc_main$9 } from "./DialogModal-98d96ed5.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$9, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-full text-center"${_scopeId}> Masukkan PIN transaksi kamu </div>`);
          } else {
            return [
        ...
        content: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="grid justify-center"${_scopeId}>`);
            ...
            if (msgError.value) {
              _push2(`<p class="w-full text-center text-sm text-red-600 mt-2"${_scopeId}>Pin salah, silahkan coba lagi.</p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
