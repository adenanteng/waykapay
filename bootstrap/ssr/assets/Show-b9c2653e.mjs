...
import { _ as _sfc_main$4 } from "./PrimaryButton-3722f774.mjs";
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class=""${_scopeId}><div class="block text-xl font-bold text-gray-900 capitalize"${_scopeId}>${ssrInterpolate(props.users.name)} <span class="text-sm font-medium ml-2 text-gray-500"${_scopeId}>#${ssrInterpolate(props.users.slug)}</span></div><div class="block text-sm font-medium text-gray-600"${_scopeId}><p${_scopeId}><i class="fa-regular fa-mobile mr-1 w-3"${_scopeId}></i> ${ssrInterpolate(props.users.phone)}</p><p${_scopeId}><i class="fa-regular fa-envelope mr-1 w-3"${_scopeId}></i> ${ssrInterpolate(props.users.email)}</p></div><div class="block text-sm font-medium text-gray-600"${_scopeId}> Akun ${ssrInterpolate(props.users.role)}</div><div class="block text-sm font-medium text-primary-600"${_scopeId}> Rp ${ssrInterpolate(formatPrice(props.users.wallet_balance))}</div></div></div><div class="mt-5 flex lg:mt-0 lg:flex-shrink-0 gap-x-2"${_scopeId}>`);
                      ...
                      createVNode("div", { class: "px-4 py-4 sm:px-6" }, [
                        ...
                        createVNode("div", { class: "flex justify-between" }, [
                          createVNode("div", { class: "flex" }, [
                            ...
                            }, toDisplayString(history.category_id == 1 || history.user_id != props.users.id ? "+" : "-") + " Rp " + toDisplayString(history.category_id == 1 ? formatPrice(history.amount) : formatPrice(history.gross_amount)), 3)
                          ]),
                          createVNode("div", {
                            class: ["flex items-center text-xs", history.status_id == 1 || history.status_id == 2 ? "text-gray-900" : "text-gray-500"]
                ...
                createVNode("div", { class: "py-4 px-4 lg:flex lg:items-center lg:justify-between" }, [
                  createVNode("div", { class: "tracking-tight flex gap-5 items-center" }, [
                    ...
                    createVNode("div", { class: "" }, [
                      ...
                      createVNode("div", { class: "block text-sm font-medium text-gray-600" }, [
                        createVNode("p", null, [
                          createVNode("i", { class: "fa-regular fa-mobile mr-1 w-3" }),
                          createTextVNode(" " + toDisplayString(props.users.phone), 1)
                        ]),
                        createVNode("p", null, [
                          createVNode("i", { class: "fa-regular fa-envelope mr-1 w-3" }),
