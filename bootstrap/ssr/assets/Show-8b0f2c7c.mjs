            ...
            if (timerSuccess.value) {
              ...
              if (props.history.status_id == 1) {
                ...
                if (props.history.category_id == 5) {
                  ...
                  _push2(`<div class="sm:col-span-2 flex sm:block justify-between gap-5"${_scopeId}><div class="text-sm"${_scopeId}>Keterangan</div><div class="text-sm font-semibold text-right sm:text-left"${_scopeId}>${ssrInterpolate(props.history.desc ?? "-")}</div></div>`);
                }
