      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("games.show", "Unipin Voucher"),
              class: "absolute inset-0"
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex w-full items-center justify-between space-x-6 p-6"${_scopeId}><img src="/img/games/Unipin%20Voucher.png" alt="" class="h-10"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}><h3 class="text-sm font-medium text-gray-900"${_scopeId}>Unipin Voucher</h3></div><p class="text-sm text-gray-500"${_scopeId}>Topup Unipin</p></div></div></li><li class="relative"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`<div class="flex w-full items-center justify-between space-x-6 p-6"${_scopeId}><img src="/img/games/Valorant.png" alt="" class="h-10"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}><h3 class="text-sm font-medium text-gray-900"${_scopeId}>Valorant</h3></div><p class="text-sm text-gray-500"${_scopeId}>Topup Valorant</p></div></div></li><li class="relative"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("games.show", "Bigo Live"),
              class: "absolute inset-0"
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex w-full items-center justify-between space-x-6 p-6"${_scopeId}><img src="/img/games/Bigo%20Live.png" alt="" class="h-10"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}><h3 class="text-sm font-medium text-gray-900"${_scopeId}>Bigo Live</h3></div><p class="text-sm text-gray-500"${_scopeId}>Topup Bigo Live</p></div></div></li><li class="relative"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("games.show", "IMVU"),
              class: "absolute inset-0"
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex w-full items-center justify-between space-x-6 p-6"${_scopeId}><img src="/img/games/IMVU.png" alt="" class="h-10"${_scopeId}><div class="flex-1"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}><h3 class="text-sm font-medium text-gray-900"${_scopeId}>IMVU</h3></div><p class="text-sm text-gray-500"${_scopeId}>Topup IMVU</p></div></div></li></ul>`);
          } else {
            return [
              createVNode("ul", {
                role: "list",
                ...
                createVNode("li", { class: "relative" }, [
                  ...
                  createVNode("div", { class: "flex w-full items-center justify-between space-x-6 p-6" }, [
                    createVNode("img", {
                      src: "/img/games/Unipin%20Voucher.png",
                      alt: "",
                      class: "h-10"
                    }),
                    createVNode("div", { class: "flex-1" }, [
                      createVNode("div", { class: "flex items-center space-x-3" }, [
                        createVNode("h3", { class: "text-sm font-medium text-gray-900" }, "Unipin Voucher")
                      ]),
                      createVNode("p", { class: "text-sm text-gray-500" }, "Topup Unipin")
                    ])
                  ])
                ]),
                createVNode("li", { class: "relative" }, [
                ...
                createVNode("li", { class: "relative" }, [
                  ...
                  createVNode("div", { class: "flex w-full items-center justify-between space-x-6 p-6" }, [
                    createVNode("img", {
                      src: "/img/games/Bigo%20Live.png",
                      alt: "",
                      class: "h-10"
                    }),
                    createVNode("div", { class: "flex-1" }, [
                      createVNode("div", { class: "flex items-center space-x-3" }, [
                        createVNode("h3", { class: "text-sm font-medium text-gray-900" }, "Bigo Live")
                      ]),
                      createVNode("p", { class: "text-sm text-gray-500" }, "Topup Bigo Live")
                    ])
                  ])
                ]),
                createVNode("li", { class: "relative" }, [
                  ...
                  createVNode("div", { class: "flex w-full items-center justify-between space-x-6 p-6" }, [
                    createVNode("img", {
                      src: "/img/games/IMVU.png",
                      alt: "",
                      class: "h-10"
                    }),
                    createVNode("div", { class: "flex-1" }, [
                      createVNode("div", { class: "flex items-center space-x-3" }, [
                        createVNode("h3", { class: "text-sm font-medium text-gray-900" }, "IMVU")
                      ]),
                      createVNode("p", { class: "text-sm text-gray-500" }, "Topup IMVU")
                    ])
                  ])
                ])
              ])
