...
import _sfc_main$2 from "./NotificationForm-b85c8977.mjs";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (_ctx.$page.props.user.device_token) {
              _push2(`<p class="mt-1 text-xs text-gray-500"${_scopeId}>${ssrInterpolate(_ctx.$page.props.user.device_token)}</p>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "col-span-1 divide-y divide-gray-300 dark:divide-gray-600 rounded-3xl bg-white bg-opacity-50 shadow-lg border border-gray-300" }, [
                ...
                createVNode("div", null, [
                  createVNode("div", { class: "flex divide-x divide-gray-300 dark:divide-gray-600" }, [
              ...
              _ctx.$page.props.user.role_id == 1 ? (openBlock(), createBlock(_sfc_main$2, { key: 0 })) : createCommentVNode("", true)
            ];
          }
        }),
        _: 1
