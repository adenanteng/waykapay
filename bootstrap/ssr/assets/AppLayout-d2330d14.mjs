...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="min-h-screen bg-white bg-glass bg-fixed object-cover">`);
        ...
        default: withCtx(({ open }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (hasPrevious.value) {
              ...
              if (props.greeting) {
                _push2(`<p class="text-4xl font-bold text-gray-900 sm:text-2xl capitalize"${_scopeId}><span class="font-medium text-gray-600"${_scopeId}>Halo,</span> ${ssrInterpolate(unref(split)[0])}. </p>`);
              } else {
                _push2(`<p class="text-4xl font-bold text-gray-900 sm:text-2xl capitalize"${_scopeId}>${ssrInterpolate(props.name)}${ssrInterpolate(props.name ? "." : "")}</p>`);
              }
            ...
            return [
              createVNode("div", { class: "max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8" }, [
                createVNode("div", { class: "relative flex flex-wrap items-center justify-start lg:justify-between" }, [
                  createVNode("div", { class: "py-5 flex-shrink-0 flex items-center" }, [
                    hasPrevious.value ? renderSlot(_ctx.$slots, "previous", { key: 0 }) : (openBlock(), createBlock("div", {
                      ...
                      createVNode("div", { class: "mt-4 sm:mt-0 sm:pt-1 text-left" }, [
                        props.greeting ? (openBlock(), createBlock("p", {
                          key: 0,
                          class: "text-4xl font-bold text-gray-900 sm:text-2xl capitalize"
                        }, [
      ...
      _push(`<main class=""><div class="max-w-3xl lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"><div class=""><div class="max-w-7xl mx-auto space-y-5 relative">`);
