import { computed, mergeProps, withCtx, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, unref, useSSRContext } from "vue";
                ...
                if (_push3) {
                  ...
                  if ((_b = props.customer.data.desc) == null ? void 0 : _b.detail) {
                    ...
                    ssrRenderList(props.customer.data.desc.detail, (item, index) => {
                      ...
                      _push3(`<div class="font-semibold text-gray-900"${_scopeId2}>${ssrInterpolate(item.periode)}</div></div><div${_scopeId2}>`);
                      ...
                      _push3(`<div class="font-semibold text-gray-900"${_scopeId2}> Rp ${ssrInterpolate(formatPrice(item.nilai_tagihan))}</div></div><div${_scopeId2}>`);
                      ...
                      _push3(`<div class="font-semibold text-gray-900"${_scopeId2}> Rp ${ssrInterpolate(formatPrice(item.denda))}</div></div></div>`);
                    });
                    _push3(`<!--]-->`);
                  } else {
                    _push3(`<!---->`);
                  ...
                  _push3(`<div class="font-semibold text-gray-900"${_scopeId2}> Rp ${ssrInterpolate(formatPrice(Number(props.customer.data.selling_price) - Number(props.customer.data.price)))} </div></div><div class="col-span-6 sm:col-span-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    for: "number",
                    value: "Total"
                  }, null, _parent3, _scopeId2));
                  ...
                  return [
                    ...
                    ((_d = props.customer.data.desc) == null ? void 0 : _d.detail) ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(props.customer.data.desc.detail, (item, index) => {
                      return openBlock(), createBlock("div", { class: "col-span-6 sm:col-span-3 space-y-5 py-5 border-y border-gray-600 border-dashed" }, [
                        ...
                        createVNode("div", null, [
                          (item == null ? void 0 : item.nilai_tagihan) ? (openBlock(), createBlock(_sfc_main$4, {
                            key: 0,
                            for: "number",
                            value: "Nilai Tagihan"
                          })) : createCommentVNode("", true),
                        ...
                        createVNode("div", null, [
                          (item == null ? void 0 : item.denda) ? (openBlock(), createBlock(_sfc_main$4, {
                            key: 0,
                            for: "number",
                            value: "Denda"
                          })) : createCommentVNode("", true),
                    ...
                    createVNode("div", { class: "col-span-6 sm:col-span-3" }, [
                      ...
                      createVNode("div", { class: "font-semibold text-gray-900" }, " Rp " + toDisplayString(formatPrice(Number(props.customer.data.selling_price) - Number(props.customer.data.price))) + " ", 1)
                    ]),
                    createVNode("div", { class: "col-span-6 sm:col-span-3" }, [
                      createVNode(_sfc_main$4, {
                        for: "number",
