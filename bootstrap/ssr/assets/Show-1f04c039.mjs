import { computed, ref, onMounted, watch, mergeProps, withCtx, openBlock, createBlock, createCommentVNode, createTextVNode, createVNode, unref, toDisplayString, Fragment, withModifiers, useSSRContext } from "vue";
            ...
            if (timerSuccess.value) {
              ...
              if (props.history.status_id == 1) {
                ...
                if (props.history.manual_account) {
                  ...
                  if (props.manual_account && _ctx.$page.props.user.role_id != 1) {
                    _push2(ssrRenderComponent(_sfc_main$4, {
                  ...
                  if (_ctx.$page.props.user.role_id == 1) {
                    _push2(ssrRenderComponent(_sfc_main$3, {
                      ...
                      default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                        if (_push3) {
                          _push3(`<i class="fa-regular fa-paper-plane mr-2"${_scopeId2}></i> Validasi `);
                        } else {
                          return [
                            createVNode("i", { class: "fa-regular fa-paper-plane mr-2" }),
              ...
              timerSuccess.value ? (openBlock(), createBlock("div", {
                ...
                props.history.status_id == 1 ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                  ...
                  props.history.manual_account ? (openBlock(), createBlock("div", {
                    ...
                    props.manual_account && _ctx.$page.props.user.role_id != 1 ? (openBlock(), createBlock(_sfc_main$4, {
                      key: 0,
                      class: "border border-gray-300",
                      as: "outside",
                      href: "https://wa.me/6285839036717",
                    ...
                    _ctx.$page.props.user.role_id == 1 ? (openBlock(), createBlock(_sfc_main$3, {
                      key: 1,
                      class: "border border-gray-300 w-full justify-center",
                      onClick: validate
                    }, {
