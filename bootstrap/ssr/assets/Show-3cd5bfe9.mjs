              ...
              ssrRenderList(sort(props.response.data), (data) => {
                ...
                if (data.brand == props.product) {
                  ...
                  if (data.type == tab.value) {
                    _push2(`<li class="relative px-6 py-5 flex items-center space-x-3"${_scopeId}><div class="flex-shrink-0"${_scopeId}><img class="h-10"${ssrRenderAttr("src", "/img/games/" + props.product + ".png")} alt=""${_scopeId}></div><div class="flex-1 min-w-0"${_scopeId}>`);
                    ...
                    data.brand == props.product ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                      data.type == tab.value ? (openBlock(), createBlock("li", {
                        ...
                        createVNode("div", { class: "flex-shrink-0" }, [
                          createVNode("img", {
                            class: "h-10",
                            src: "/img/games/" + props.product + ".png",
                            alt: ""
                          }, null, 8, ["src"])
                        ]),
