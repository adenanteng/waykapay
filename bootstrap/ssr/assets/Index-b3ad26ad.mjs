...
const _sfc_main = {
  ...
  props: {
    ...
    trx: void 0,
    gross_amount: void 0,
    agent_commission: void 0,
    prev_trx: void 0,
    prev_gross_amount: void 0,
    prev_agent_commission: void 0
  },
  setup(__props) {
    const props = __props;
    onMounted(() => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><dl class="mt-2 grid grid-cols-1 divide-y divide-gray-300 dark:divide-gray-600 overflow-hidden rounded-3xl bg-white bg-opacity-50 backdrop-blur border border-gray-300 shadow-lg md:grid-cols-3 md:divide-y-0 md:divide-x"${_scopeId}><!--[-->`);
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              as: "a",
              href: _ctx.route("report.detail"),
              class: ""
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Lihat Detail Laporan <i class="fa-duotone fa-arrow-right ml-2"${_scopeId2}></i>`);
                } else {
                  return [
                    createTextVNode(" Lihat Detail Laporan "),
            ...
            return [
              createVNode("div", null, [
                createVNode("dl", { class: "mt-2 grid grid-cols-1 divide-y divide-gray-300 dark:divide-gray-600 overflow-hidden rounded-3xl bg-white bg-opacity-50 backdrop-blur border border-gray-300 shadow-lg md:grid-cols-3 md:divide-y-0 md:divide-x" }, [
