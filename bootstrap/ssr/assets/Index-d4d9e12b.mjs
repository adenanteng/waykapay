          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$3, { onSubmitted: storeInformation }, {
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Tagihan <span class="capitalize"${_scopeId2}>${ssrInterpolate(props.sku.replace("-", " "))}</span>`);
                } else {
                  return [
                    createTextVNode(" Tagihan "),
                    createVNode("span", { class: "capitalize" }, toDisplayString(props.sku.replace("-", " ")), 1)
                  ];
                }
              }),
