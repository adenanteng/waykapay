        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(props.transaction, (date2, index) => {
              _push2(`<!--[--><h3 class="text-sm text-gray-600 font-medium ml-5 mt-5 mb-1"${_scopeId}>${ssrInterpolate(index)}</h3><div class="rounded-3xl bg-white bg-opacity-50 backdrop-blur-2xl overflow-hidden shadow-lg border border-gray-300"${_scopeId}><ul role="list" class="divide-y divide-gray-300 dark:divide-gray-600"${_scopeId}><!--[-->`);
              ...
              createVNode("div", { class: "" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(props.transaction, (date2, index) => {
                  return openBlock(), createBlock(Fragment, null, [
                    createVNode("h3", { class: "text-sm text-gray-600 font-medium ml-5 mt-5 mb-1" }, toDisplayString(index), 1),
