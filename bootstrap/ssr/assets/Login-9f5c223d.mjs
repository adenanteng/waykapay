    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        ...
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Nikmati mudahnya bertranksi. transfer apa aja, bayar apa aja dan kapan aja. `);
          } else {
            return [
              createTextVNode(" Nikmati mudahnya bertranksi. transfer apa aja, bayar apa aja dan kapan aja. ")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="grid gap-4 items-center mt-4"${_scopeId}>`);
            if (__props.canResetPassword) {
              _push2(ssrRenderComponent(unref(Link), {
                href: _ctx.route("password.request"),
                class: "underline text-sm font-semibold text-primary-600 hover:text-primary-900 text-right"
              }, {
            ...
            _push2(ssrRenderComponent(_sfc_main$7, {
              ...
              class: "w-full justify-center mt-5 border border-gray-600 dark:border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(` Daftar `);
            ...
            return [
              ...
              createVNode("form", {
                ...
                createVNode("div", { class: "grid gap-4 items-center mt-4" }, [
