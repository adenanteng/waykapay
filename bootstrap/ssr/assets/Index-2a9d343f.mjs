import { onMounted, computed, ref, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString, unref, openBlock, createBlock, createCommentVNode, withDirectives, vShow, Fragment, renderList, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (provider(unref(form).customer_no) == "XL") {
              _push2(`<button class="${ssrRenderClass([tabData.value == "Xtra Combo Mini" ? "border-primary-500 text-primary-600" : "text-gray-500 border-gray-300", "w-full py-4 px-1 text-center border-b-2 font-medium text-sm"])}"${_scopeId}> Xtra Combo Mini </button>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              ...
              withDirectives(createVNode("div", { class: "border-b border-gray-300" }, [
                createVNode("nav", {
                  ...
                  provider(unref(form).customer_no) == "XL" ? (openBlock(), createBlock("button", {
                    key: 2,
                    class: ["w-full py-4 px-1 text-center border-b-2 font-medium text-sm", tabData.value == "Xtra Combo Mini" ? "border-primary-500 text-primary-600" : "text-gray-500 border-gray-300"],
                    onClick: ($event) => tabData.value = "Xtra Combo Mini"
                  }, " Xtra Combo Mini ", 10, ["onClick"])) : createCommentVNode("", true)
                ])
              ], 512), [
              ...
              createVNode("ul", {
                ...
                props.response === void 0 ? (openBlock(), createBlock(Fragment, { key: 0 }, [], 64)) : ((_b = props.response.data) == null ? void 0 : _b.rc) ? (openBlock(), createBlock("div", {
                  key: 1,
