                    ...
                    createVNode("div", { class: "text-center" }, [
                      ...
                      createVNode("div", { class: "" }, [
                        createVNode("div", { class: "text-sm text-gray-900" }, [
                          createVNode("span", { class: "class text-gray-600" }, " (" + toDisplayString(props.transaction.rc ?? "null") + ") ", 1),
                          createTextVNode(" " + toDisplayString(props.transaction.message ?? "Transaksi Gagal"), 1)
                        ])
                      ]),
