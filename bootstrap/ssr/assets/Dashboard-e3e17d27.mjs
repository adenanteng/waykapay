      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class=""${_scopeId}><h3 class="text-gray-700 text-sm ml-3 mb-1"${_scopeId}>Prabayar</h3><div class="grid grid-cols-3 grid-rows-6 grid-flow-col bg-white bg-opacity-50 backdrop-blur-2xl rounded-3xl shadow-lg border border-gray-300"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("pulsa.index"),
              class: "row-span-4 flex justify-center items-center border-b border-r border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-mobile text-5xl text-sky-600"${_scopeId2}></i><p class="text-xs text-sky-600 dark:text-gray-900 mt-1"${_scopeId2}>Pulsa &amp; Data</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-mobile text-5xl text-sky-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "row-span-2 py-3 flex justify-center items-center border-r border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-lightbulb text-2xl text-amber-600"${_scopeId2}></i><p class="text-xs text-amber-600 dark:text-gray-900"${_scopeId2}>Listrik</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-lightbulb text-2xl text-amber-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "row-span-2 py-3 flex justify-center items-center border-b border-r border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-gamepad-modern text-2xl text-teal-600"${_scopeId2}></i><p class="text-xs text-teal-600 dark:text-gray-900"${_scopeId2}>Games</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-gamepad-modern text-2xl text-teal-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-ticket text-2xl text-violet-600"${_scopeId2}></i><p class="text-xs text-violet-600 dark:text-gray-900"${_scopeId2}>Voucher</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-ticket text-2xl text-violet-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "row-span-2 col-span-2 py-3 flex justify-center items-center"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-wallet text-2xl text-blue-600"${_scopeId2}></i><p class="text-xs text-blue-600 dark:text-gray-900"${_scopeId2}>E-Money</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-wallet text-2xl text-blue-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "row-span-2 py-3 flex justify-center items-center border-b border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-tv-retro text-2xl text-green-600"${_scopeId2}></i><p class="text-xs text-green-600 dark:text-gray-900"${_scopeId2}>TV</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-tv-retro text-2xl text-green-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-cards-blank text-2xl text-red-600"${_scopeId2}></i><p class="text-xs text-red-600 dark:text-gray-900"${_scopeId2}>E-Toll</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-cards-blank text-2xl text-red-600" }),
            ...
            _push2(`</div></div><div class=""${_scopeId}><h3 class="text-gray-700 text-sm ml-3 mb-1"${_scopeId}>Pascabayar</h3><div class="grid grid-cols-3 bg-white bg-opacity-50 backdrop-blur-2xl rounded-3xl shadow-lg border border-gray-300"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
              href: _ctx.route("pasca.bpjs.index"),
              class: "py-3 rounded-l-3xl flex justify-center items-center border-r border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-heart-pulse text-2xl text-green-600"${_scopeId2}></i><p class="text-xs text-green-600 dark:text-gray-900"${_scopeId2}>BPJS</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-heart-pulse text-2xl text-green-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "py-3 flex justify-center items-center border-r border-gray-300"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-router text-2xl text-red-600"${_scopeId2}></i><p class="text-xs text-red-600 dark:text-gray-900"${_scopeId2}>Internet</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-router text-2xl text-red-600" }),
            ...
            _push2(ssrRenderComponent(unref(Link), {
              ...
              class: "py-3 rounded-r-3xl flex justify-center items-center"
            }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="text-center"${_scopeId2}><i class="fa-regular fa-credit-card text-2xl text-blue-600"${_scopeId2}></i><p class="text-xs text-blue-600 dark:text-gray-900"${_scopeId2}>Cicilan</p></div>`);
                } else {
                  return [
                    createVNode("div", { class: "text-center" }, [
                      createVNode("i", { class: "fa-regular fa-credit-card text-2xl text-blue-600" }),
                      createVNode("p", { class: "text-xs text-blue-600 dark:text-gray-900" }, "Cicilan")
                    ])
                  ];
                }
              }),
            ...
            if (props.history === void 0) {
              _push2(`<div class="animate-pulse rounded-3xl bg-white bg-opacity-50 backdrop-blur-2xl shadow-lg border border-gray-300 divide-y divide-gray-300"${_scopeId}><!--[-->`);
              ssrRenderList(5, (loader) => {
                ...
                _push2(ssrRenderComponent(unref(Link), {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      } else if (history.offline_account) {
                        _push3(`<!--[-->${ssrInterpolate(history.offline_account.bank)}<!--]-->`);
                      } else if (history.manual_account) {
                        _push3(`<!--[-->${ssrInterpolate(history.manual_account.bank)}<!--]-->`);
                        ...
                        createVNode("div", { class: "px-4 py-4 sm:px-6" }, [
                          createVNode("div", { class: "flex items-center justify-between" }, [
                            createVNode("p", {
                              ...
                              ], 64)) : history.offline_account ? (openBlock(), createBlock(Fragment, { key: 2 }, [
                                createTextVNode(toDisplayString(history.offline_account.bank), 1)
                              ], 64)) : history.manual_account ? (openBlock(), createBlock(Fragment, { key: 3 }, [
                                createTextVNode(toDisplayString(history.manual_account.bank), 1)
                              ], 64)) : history.money_transfer ? (openBlock(), createBlock(Fragment, { key: 4 }, [
            ...
            return [
              ...
              createVNode("div", { class: "" }, [
                ...
                createVNode("div", { class: "grid grid-cols-3 grid-rows-6 grid-flow-col bg-white bg-opacity-50 backdrop-blur-2xl rounded-3xl shadow-lg border border-gray-300" }, [
                  createVNode(unref(Link), {
                    href: _ctx.route("pulsa.index"),
                    class: "row-span-4 flex justify-center items-center border-b border-r border-gray-300"
                  }, {
              ...
              createVNode("div", { class: "" }, [
                ...
                createVNode("div", { class: "grid grid-cols-3 bg-white bg-opacity-50 backdrop-blur-2xl rounded-3xl shadow-lg border border-gray-300" }, [
                  createVNode(unref(Link), {
                    href: _ctx.route("pasca.bpjs.index"),
                    class: "py-3 rounded-l-3xl flex justify-center items-center border-r border-gray-300"
                  }, {
              ...
              createVNode("div", { class: "" }, [
                ...
                props.history === void 0 ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "animate-pulse rounded-3xl bg-white bg-opacity-50 backdrop-blur-2xl shadow-lg border border-gray-300 divide-y divide-gray-300"
                }, [
                  (openBlock(), createBlock(Fragment, null, renderList(5, (loader) => {
