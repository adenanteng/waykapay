import { onMounted, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from "vue";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (props.history.category_id == 5) {
              ...
              _push2(`<div class="flex justify-between gap-5"${_scopeId}><div class="text-sm"${_scopeId}>Keterangan</div><div class="text-sm font-semibold text-right"${_scopeId}>${ssrInterpolate(((_g = (_f = props.history) == null ? void 0 : _f.desc) == null ? void 0 : _g.replaceAll("/", " ")) ?? "-")}</div></div>`);
            }
            ...
            if (props.history.service_fee != 0) {
              _push2(`<div class="flex justify-between"${_scopeId}><div class="text-sm"${_scopeId}>Biaya Layanan</div><div class="text-sm font-semibold"${_scopeId}> Rp ${ssrInterpolate(formatPrice(props.history.service_fee))}</div></div>`);
            } else {
              _push2(`<!---->`);
            }
            ...
            return [
              createVNode("div", { class: "border border-gray-300 my-5" }, [
                ...
                createVNode("div", { class: "border-t border-gray-600 border-dashed px-4 py-5" }, [
                  createVNode("div", { class: "grid grid-cols-1 gap-x-4 gap-y-2 text-gray-900" }, [
                    ...
                    props.history.category_id == 5 ? (openBlock(), createBlock(Fragment, { key: 5 }, [
                      ...
                      createVNode("div", { class: "text-sm font-semibold text-right" }, toDisplayString(((_n = (_m = props.history) == null ? void 0 : _m.desc) == null ? void 0 : _n.replaceAll("/", " ")) ?? "-"), 1)
                    ])),
                    createVNode("span", { class: "my-2 border-t border-gray-600 border-dashed block" }),
                    createVNode("div", { class: "flex justify-between" }, [
                    ...
                    props.history.service_fee != 0 ? (openBlock(), createBlock("div", {
                      key: 7,
                      class: "flex justify-between"
                    }, [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/History/Print.vue");
