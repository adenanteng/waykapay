  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["mb-5 sm:mt-0", hasTitle.value ? "md:grid md:grid-cols-4 md:gap-6" : ""]
      }, _attrs))}>`);
      if (hasTitle.value) {
      ...
      _push(`<div class="mt-5 md:mt-0 md:col-span-3"><form><div class="${ssrRenderClass([hasActions.value ? "rounded-tl-3xl rounded-tr-3xl" : "rounded-3xl", "px-4 py-5 bg-white bg-opacity-50 backdrop-blur-2xl sm:p-6 shadow-lg border border-gray-300"])}"><div class="grid grid-cols-6 gap-6">`);
