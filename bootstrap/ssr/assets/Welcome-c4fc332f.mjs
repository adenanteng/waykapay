import { defineComponent, h, mergeProps, withCtx, createVNode, resolveDynamicComponent, createTextVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, useSSRContext } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrRenderVNode, ssrInterpolate, ssrRenderAttr } from "vue/server-renderer";
import { _ as _sfc_main$1 } from "./LandingLayout-2a6dfa6d.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<main${_scopeId}><div class="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40"${_scopeId}><div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto"${_scopeId}><div class="flex"${_scopeId}><div class="relative flex items-center gap-x-4 rounded-full py-1 px-4 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20"${_scopeId}><span class="font-semibold text-primary-600"${_scopeId}>We’re hiring</span><span class="h-4 w-px bg-gray-900/10" aria-hidden="true"${_scopeId}></span><a href="#" class="flex items-center gap-x-1"${_scopeId}><span class="absolute inset-0" aria-hidden="true"${_scopeId}></span> See open positions <i class="fa-regular fa-angle-right text-gray-400 ml-1"${_scopeId}></i></a></div></div><h1 class="mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl"${_scopeId}>Waykapay</h1><p class="mt-6 text-lg leading-8 text-gray-600"${_scopeId}> Satu aplikasi untuk transfer apa aja, bayar apa aja dan kapan aja. <br${_scopeId}> Unduh aplikasi Waykapay sekarang! </p><div class="mt-10 flex items-center gap-x-3"${_scopeId}><a target="_blank" href="https://play.google.com/store/apps/details?id=com.anteng.waykapay&amp;pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"${_scopeId}><img alt="Temukan di Google Play" src="https://play.google.com/intl/id/badges/static/images/badges/id_badge_web_generic.png" class="h-16"${_scopeId}></a></div></div><div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow"${_scopeId}><div class="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px]"${_scopeId}><div class="h-[32px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[72px] rounded-s-lg"${_scopeId}></div><div class="h-[46px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg"${_scopeId}></div><div class="h-[46px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg"${_scopeId}></div><div class="h-[64px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg"${_scopeId}></div><div class="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800"${_scopeId}><img src="/img/landing/dashboard-dark.png" class="dark:hidden w-[272px] h-[572px]" alt=""${_scopeId}><img src="/img/landing/dashboard-light.png" class="hidden dark:block w-[272px] h-[572px]" alt=""${_scopeId}></div></div></div></div><div class=""${_scopeId}><div class="mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8"${_scopeId}><p class="text-center text-lg font-semibold text-gray-600"${_scopeId}>Topup e-wallet, games, voucher, internet dan isi pulsa</p><div class="mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8"${_scopeId}><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/AXIS.svg" alt=""${_scopeId}></div><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/TIX%20ID.svg" alt=""${_scopeId}></div><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/INDIHOME.svg" alt=""${_scopeId}></div><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/SPOTIFY.svg" alt=""${_scopeId}></div><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/DANA.svg" alt=""${_scopeId}></div><div class="col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8"${_scopeId}><img class="max-h-12" src="/img/vendor/SHOPEE%20PAY.svg" alt=""${_scopeId}></div></div></div></div><div class="relative overflow-hidden pt-16 pb-32"${_scopeId}><div class="relative"${_scopeId}><div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8"${_scopeId}><div class="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0"${_scopeId}><div${_scopeId}><div${_scopeId}><span class="flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-r from-blue-600 to-primary-600"${_scopeId}><i class="fa-regular fa-wallet text-xl text-white nightwind-prevent"${_scopeId}></i></span></div><div class="mt-6"${_scopeId}><h2 class="text-3xl font-bold tracking-tight text-gray-900"${_scopeId}>Seperti dompetmu, tapi lebih canggih</h2><p class="mt-4 text-lg text-gray-500"${_scopeId}> Waykapay bikin kamu lebih mudah untuk akses semua kebutuhan transaksi dan mulai berinvestasi. </p><div class="mt-6"${_scopeId}></div></div></div><div class="mt-8 border-t border-gray-200 pt-6"${_scopeId}><blockquote${_scopeId}><div${_scopeId}><p class="text-base text-gray-500"${_scopeId}>“Cras velit quis eros eget rhoncus lacus ultrices sed diam. Sit orci risus aenean curabitur donec aliquet. Mi venenatis in euismod ut.”</p></div><footer class="mt-3"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}><div class="flex-shrink-0"${_scopeId}><img class="h-6 w-6 rounded-full" src="https://images.unsplash.com/photo-1509783236416-c9ad59bae472?ixlib=rb-=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=8&amp;w=1024&amp;h=1024&amp;q=80" alt=""${_scopeId}></div><div class="text-base font-medium text-gray-700"${_scopeId}>Marcia Hill, Digital Marketing Manager</div></div></footer></blockquote></div></div><div class="mt-12 sm:mt-16 lg:mt-0"${_scopeId}><div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0"${_scopeId}><img class="w-full rounded-3xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none" src="https://tailwindui.com/img/component-images/inbox-app-screenshot-1.jpg" alt="Inbox user interface"${_scopeId}></div></div></div></div><div class="mt-24"${_scopeId}><div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8"${_scopeId}><div class="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0"${_scopeId}><div${_scopeId}><div${_scopeId}><span class="flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-r from-blue-600 to-primary-600"${_scopeId}><i class="fa-regular fa-shield-check text-xl text-white nightwind-prevent"${_scopeId}></i></span></div><div class="mt-6"${_scopeId}><h2 class="text-3xl font-bold tracking-tight text-gray-900"${_scopeId}>Perlindungan dengan Waykapay Protection</h2><p class="mt-4 text-lg text-gray-500"${_scopeId}> Dengan standar keamanan PCI DSS &amp; ISO 27001, Waykapay mengamankan data pembayaran dan informasi milikmu. Garansi berlaku saat ada kehilangan uang di Saldo Waykapay &amp; sumber uang lainnya yang tersimpan di Waykapay. </p><div class="mt-6"${_scopeId}></div></div></div></div><div class="mt-12 sm:mt-16 lg:col-start-1 lg:mt-0"${_scopeId}><div class="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0"${_scopeId}><img class="w-full rounded-3xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none" src="https://tailwindui.com/img/component-images/inbox-app-screenshot-2.jpg" alt="Customer profile user interface"${_scopeId}></div></div></div></div></div><div class="bg-gradient-to-r from-blue-800 to-primary-700 nightwind-prevent-block"${_scopeId}><div class="mx-auto max-w-4xl py-16 px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:px-8 lg:pt-24"${_scopeId}><h2 class="text-3xl font-bold tracking-tight text-white"${_scopeId}>Inbox support built for efficiency</h2><p class="mt-4 max-w-3xl text-lg text-blue-200"${_scopeId}>Ac tincidunt sapien vehicula erat auctor pellentesque rhoncus. Et magna sit morbi lobortis. Blandit aliquam sit nisl euismod mattis in.</p><div class="mt-12 grid grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-x-8 lg:gap-y-16"${_scopeId}><!--[-->`);
            ...
            return [
              createVNode("main", null, [
                createVNode("div", { class: "mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40" }, [
                  createVNode("div", { class: "mx-auto max-w-2xl lg:mx-0 lg:flex-auto" }, [
                    createVNode("div", { class: "flex" }, [
                      createVNode("div", { class: "relative flex items-center gap-x-4 rounded-full py-1 px-4 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20" }, [
                        createVNode("span", { class: "font-semibold text-primary-600" }, "We’re hiring"),
                        createVNode("span", {
                        ...
                        createVNode("a", {
                          ...
                          createTextVNode(" See open positions "),
                          createVNode("i", { class: "fa-regular fa-angle-right text-gray-400 ml-1" })
                        ])
                      ])
                    ]),
                    createVNode("h1", { class: "mt-10 max-w-lg text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl" }, "Waykapay"),
                    createVNode("p", { class: "mt-6 text-lg leading-8 text-gray-600" }, [
                      createTextVNode(" Satu aplikasi untuk transfer apa aja, bayar apa aja dan kapan aja. "),
                      createVNode("br"),
                      createTextVNode(" Unduh aplikasi Waykapay sekarang! ")
                    ]),
                    createVNode("div", { class: "mt-10 flex items-center gap-x-3" }, [
                      createVNode("a", {
                        target: "_blank",
                        href: "https://play.google.com/store/apps/details?id=com.anteng.waykapay&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1"
                      }, [
                        createVNode("img", {
                  ...
                  createVNode("div", { class: "mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow" }, [
                    createVNode("div", { class: "relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[14px] rounded-[2.5rem] h-[600px] w-[300px]" }, [
                      createVNode("div", { class: "h-[32px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[72px] rounded-s-lg" }),
                      createVNode("div", { class: "h-[46px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[124px] rounded-s-lg" }),
                      createVNode("div", { class: "h-[46px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -start-[17px] top-[178px] rounded-s-lg" }),
                      createVNode("div", { class: "h-[64px] w-[3px] bg-gray-800 dark:bg-gray-800 absolute -end-[17px] top-[142px] rounded-e-lg" }),
                      createVNode("div", { class: "rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white dark:bg-gray-800" }, [
                        createVNode("img", {
                          src: "/img/landing/dashboard-dark.png",
                          class: "dark:hidden w-[272px] h-[572px]",
                          alt: ""
                        }),
                        createVNode("img", {
                          src: "/img/landing/dashboard-light.png",
                ...
                createVNode("div", { class: "" }, [
                  createVNode("div", { class: "mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8" }, [
                    createVNode("p", { class: "text-center text-lg font-semibold text-gray-600" }, "Topup e-wallet, games, voucher, internet dan isi pulsa"),
                    createVNode("div", { class: "mt-6 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-8" }, [
                      createVNode("div", { class: "col-span-1 flex justify-center bg-gray-100 bg-opacity-50 py-8 px-8" }, [
                        createVNode("img", {
                          class: "max-h-12",
                        ...
                        createVNode("div", null, [
                          createVNode("div", null, [
                            createVNode("span", { class: "flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-r from-blue-600 to-primary-600" }, [
                              createVNode("i", { class: "fa-regular fa-wallet text-xl text-white nightwind-prevent" })
                            ])
                          ]),
                          createVNode("div", { class: "mt-6" }, [
                            createVNode("h2", { class: "text-3xl font-bold tracking-tight text-gray-900" }, "Seperti dompetmu, tapi lebih canggih"),
                            createVNode("p", { class: "mt-4 text-lg text-gray-500" }, " Waykapay bikin kamu lebih mudah untuk akses semua kebutuhan transaksi dan mulai berinvestasi. "),
                            createVNode("div", { class: "mt-6" })
                          ])
                        ]),
                    ...
                    createVNode("div", { class: "lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8" }, [
                      createVNode("div", { class: "mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:py-32 lg:px-0" }, [
                        createVNode("div", null, [
                          createVNode("div", null, [
                            createVNode("span", { class: "flex h-12 w-12 items-center justify-center rounded-3xl bg-gradient-to-r from-blue-600 to-primary-600" }, [
                              createVNode("i", { class: "fa-regular fa-shield-check text-xl text-white nightwind-prevent" })
                            ])
                          ]),
                          createVNode("div", { class: "mt-6" }, [
                            createVNode("h2", { class: "text-3xl font-bold tracking-tight text-gray-900" }, "Perlindungan dengan Waykapay Protection"),
                            createVNode("p", { class: "mt-4 text-lg text-gray-500" }, " Dengan standar keamanan PCI DSS & ISO 27001, Waykapay mengamankan data pembayaran dan informasi milikmu. Garansi berlaku saat ada kehilangan uang di Saldo Waykapay & sumber uang lainnya yang tersimpan di Waykapay. "),
                            createVNode("div", { class: "mt-6" })
                          ])
                        ])
                      ]),
