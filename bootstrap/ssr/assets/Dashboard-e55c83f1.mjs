      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class=""${_scopeId}><h3 class="text-gray-700 text-sm ml-3 mb-1"${_scopeId}>Prabayar</h3><div class="grid grid-cols-3 grid-rows-6 grid-flow-col rounded-3xl shadow-lg border border-gray-300"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            _push2(`</div></div><div class=""${_scopeId}><h3 class="text-gray-700 text-sm ml-3 mb-1"${_scopeId}>Pascabayar</h3><div class="grid grid-cols-3 rounded-3xl shadow-lg border border-gray-300"${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Link), {
            ...
            return [
              ...
              createVNode("div", { class: "" }, [
                ...
                createVNode("div", { class: "grid grid-cols-3 grid-rows-6 grid-flow-col rounded-3xl shadow-lg border border-gray-300" }, [
                  createVNode(unref(Link), {
                    href: _ctx.route("pulsa.index"),
                    class: "row-span-4 flex justify-center items-center border-b border-r border-gray-300"
                  }, {
              ...
              createVNode("div", { class: "" }, [
                ...
                createVNode("div", { class: "grid grid-cols-3 rounded-3xl shadow-lg border border-gray-300" }, [
                  createVNode(unref(Link), {
                    href: _ctx.route("pasca.bpjs.index"),
                    class: "py-3 rounded-l-3xl flex justify-center items-center border-r border-gray-300"
                  }, {
