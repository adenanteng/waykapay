    ...
    <div class="mb-5 sm:mt-0 " :class="hasTitle ? 'md:grid md:grid-cols-4 md:gap-6' : '' ">
        ...
        <div class="mt-5 md:mt-0 md:col-span-3">
            ...
            <form @submit.prevent="$emit('submitted')">
                <div
                    class="px-4 py-5 bg-white bg-opacity-20 sm:p-6 shadow-lg border border-gray-300"
                    :class="hasActions ? 'rounded-tl-3xl rounded-tr-3xl' : 'rounded-3xl backdrop-blur-sm'"
                >
