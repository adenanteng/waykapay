...
<template>
    <div class="rounded-t-3xl bg-white bg-opacity-50 backdrop-blur-2xl border-t border-gray-300 overflow-hidden shadow-lg fixed bottom-0 right-0 left-0 lg:hidden z-50">
        <div class="pt-3 pb-2">
