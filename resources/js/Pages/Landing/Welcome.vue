...
<!--                                <ApplicationLogo />-->
                                ...
                                <h1 class="mt-10 text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                                    Semua transaksi bisa di Waykapay
                                </h1>
                                ...
                                <div class="mt-10 flex items-center gap-x-6">
                                    <PrimaryButton :href="route('register')">Daftar</PrimaryButton>
                                    <SecondaryButton as="a" :href="route('dashboard')">Dashboard <i class="fa-regular fa-arrow-right ml-1 text-sm" /></SecondaryButton>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-20 sm:mt-24 md:mx-auto md:max-w-2xl lg:mx-0 lg:mt-0 lg:w-screen">
                        <div
                            class="absolute inset-y-0 right-1/2 -z-10 -mr-10 w-[200%] skew-x-[-30deg] bg-white shadow-xl shadow-primary-600/10 ring-1 ring-primary-50 md:-mr-20 lg:-mr-36" aria-hidden="true"/>
                                        ...
                                        <div class="w-screen overflow-hidden rounded-tl-xl bg-gray-900">
                                            <div class="flex bg-gray-800/40 ring-1 ring-white/5">
                                                <div class="-mb-px flex text-sm font-medium leading-6 text-gray-400">
                                                    ...
                                                    <div class="border-r border-gray-600/10 py-2 px-4">App.vue</div>
                                                </div>
                                            </div>
            ...
            <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8">
                    <h2 class="max-w-md mx-auto text-3xl font-extrabold text-primary-900 text-center lg:max-w-xl lg:text-left">
                        The world's most innovative companies use Workflow</h2>
