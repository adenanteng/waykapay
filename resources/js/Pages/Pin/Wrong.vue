        ...
        <div class="relative isolate overflow-hidden">
            ...
            <div class="mx-auto max-w-7xl px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                    ...
                    <!--                        </a>-->
                    <!--                    </div>-->
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Pin salah</h1>
                    <p class="text-sm text-gray-600">Masukkan pin transaksi kamu dengan benar</p>
                    <div class="mt-10">
                        <div class="">
                            <!--                            :placeholder="['*', '*', '*', '*']"-->
<!--                            <VOtpInput-->
...
<!--                            <p v-if="msgError" class="text-sm text-red-600 mt-2">Pin salah</p>-->
                        ...
                        <PrimaryButton
                            onclick="history.back();return false;" preserve-scroll
                        >
                            <i class="fa-regular fa-arrow-rotate-left mr-1" />
                            Coba lagi
                        </PrimaryButton>
                        ...
                        >
                            Beranda <i class="fa-regular fa-arrow-right ml-1 text-sm" />
                        </SecondaryButton>
                    </div>
                </div>
