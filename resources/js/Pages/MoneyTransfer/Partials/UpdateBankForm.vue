...
const bankLists = [
    ...
    { id: 2, name: 'CENAIDJA', logo: '/img/vendor/BCA.svg', admin: 0, disabled: false },
    { id: 3, name: 'BNINIDJA', logo: '/img/vendor/BNI.svg', admin: 0, disabled: false },
    { id: 4, name: 'BRINIDJA', logo: '/img/vendor/BRI.svg', admin: 0, disabled: true },
    { id: 5, name: 'Bank MANDIRI', logo: '/img/vendor/MANDIRI.svg', admin: 0, disabled: false },
    { id: 6, name: 'permata', logo: '/img/vendor/PERMATA.svg', admin: 0, disabled: true },
    { id: 7, name: 'bsm', logo: '/img/vendor/BSI.svg', admin: 0, disabled: true },
]
