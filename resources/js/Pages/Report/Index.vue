...
<template>
    ...
    >
        <div>
            <dl class="mt-2 grid grid-cols-1 divide-y divide-gray-300 dark:divide-gray-600 overflow-hidden rounded-3xl bg-white bg-opacity-20 backdrop-blur-sm border border-gray-300 shadow-lg md:grid-cols-3 md:divide-y-0 md:divide-x">
